...
<form action="code/consultantregistrationcode.jsp" method="post">
     ...
     <li><a href="enquiry.jsp">ENQUIRY</a></li>
                    ...
                    <div id="main"style="background-color: activecaption"><br/><br/><br/><br/><br/>
                        <div style="width:560px;height:460px;background-color:#ccccff;background-color: buttonhighlight;margin:0 auto">
                            <br/><br/><br/><br/> <h2 style="text-align:center;"> CONSULTANT &nbsp;REGISTRATION</h2>
                     <br/><br/>
                                <table cellspacing="5px;" cellpadding="5px;" style="margin:0 auto;">
                                    <tr><td> Consultant Name;</td><td><input type="text" name="con_name"/></td></tr>
