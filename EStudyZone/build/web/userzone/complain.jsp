        ...
        <div id="wrapper">
            ...
            <div id="contain1">
                ...
                <div id="main" style="background-image:url('images/umain.jpg'); background-repeat:no-repeat;background-size: cover; ">
                     <br/><br/><br/><br/>
                        <div style="width:530px;height:400px;background-color:beige;margin:0 auto">
                          <br/><br/><br/><br/><br/>
                           <h2 style=" color:#003332; text-align:center;">COMPLAIN FORM</h2>
                         <br/>
                        <table style="margin:0 auto">
                                    <tr><td>Enter Complain : </td><td><textarea name="complaintext" style="height: 125px;width:200px;"></textarea></td></tr>
                           
                            <tr><td>&nbsp;</td><td><input type="submit"  value="SUBMIT"  style="width:110px; height: 38px;"/></td></tr>
                                </table>
                        </div>        
                </div>
            <div id="footer">
