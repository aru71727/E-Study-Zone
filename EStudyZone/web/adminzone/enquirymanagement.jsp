...
<html>
    ...
    <body style="background-image:url('images/back.jpg'); background-repeat:no-repeat;background-size: cover; ">
     ...
     <li><a href="adminlogout.jsp">LOGOUT</a></li>
               ...
               <div id="main"style="background-image:url('images/1.jpg'); background-repeat:no-repeat;background-size: cover; "> <center>
                       <br/><br/><br/>         <h2 style="color:green;"><u>ENQUIRY MANAGEMENT</u></h2>
                    <br/><br/><br/>
