        ...
        <div id="wrapper">
            ...
            <div id="contain1">
                ...
                <div id="main" style="background-image:url('images/umain.jpg'); background-repeat:no-repeat;background-size: cover; " >
                     <br/><br/><br/><br/><br/><br/>
                        <div style="width:560px;height:400px;background-color:bisque;margin:0 auto">
                            <br/><br/><br/><br/><strong>
                          <h2 style=" color:#003332; text-align:center;">FEEDBACK FORM</h2>
                                    <br/><br/>
                                <table style="margin:0 auto">
                                    <tr><td>Enter Feedback : </td><td><textarea name="feedbacktext" style="height: 125px;width:200px;"></textarea></td></tr>
                           
                            <tr><td>&nbsp;</td><td><input type="submit" value="SUBMIT"  style="width:160px; height: 38px;"/></td></tr>
                                </table></strong>
                        </div></div>
            <div id="footer">
                <div id="lfooter">
